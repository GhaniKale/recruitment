            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-lg w-full relative z-10 overflow-hidden transform scale-100 transition-transform border border-slate-200 dark:border-slate-700">
                ...
                <div className="p-6 md:p-8">
                    <p className="text-slate-700 dark:text-slate-300 mb-4 leading-relaxed">
                        PT Mardel <strong>TIDAK PERNAH</strong> memungut biaya apapun dari kandidat selama proses rekrutmen (tiket pesawat, akomodasi, biaya admin, dll).
                    </p>
                    <p className="text-slate-700 dark:text-slate-300 mb-6 leading-relaxed">
                        Mohon abaikan jika ada pihak yang mengatasnamakan PT Mardel dan meminta sejumlah uang. Segera laporkan ke kontak resmi kami.
                    </p>
