...
const countries = [
    ...
    },
    {
        ...
        bgColor: 'bg-red-50 dark:bg-red-950/20',
        description: 'Program penempatan tenaga kerja ke Singapore di sektor hospitality, dan ART.',
        requirements: [
            'Usia Min 18 tahun',
            'Sehat jasmani & rohani',
            'Pendidikan min. SMP/sederajat',
            'Bersedia mengikuti pelatihan',
            'Wajib mengikuti tes Bahasa Inggris',
        ],
        stages: [
            { title: 'Pembayaran Pertama', amount: 'Rp 2.000.000', desc: 'Pendaftaran awal, verifikasi dokumen, dan seleksi berkas.' },
            { title: 'Pembayaran Kedua', amount: 'gratis', desc: 'Pengurusan kontrak kerja, medical check-up, legalitas dokumen.' },
            { title: 'Pembayaran Ketiga', amount: 'gratis', desc: 'Visa kerja, tiket pesawat, asuransi, dan pembekalan akhir.' },
        ],
    },
    {
        id: 'taiwan',
        ...
        borderColor: 'border-blue-600',
        bgColor: 'bg-blue-50 dark:bg-blue-950/20',
        description: 'Program penempatan tenaga kerja ke Taiwan di sektor hospitality, careworker, dan manufaktur.',
        requirements: [
            'Usia Min 18 tahun',
            'Sehat jasmani & rohani',
            'Pendidikan min. SMP/sederajat',
            'Bersedia mengikuti pelatihan',
            'Wajib mengikuti tes Bahasa Inggris/Mandarin',
        ],
        stages: [
            { title: 'Pembayaran Pertama', amount: 'Rp 2.000.000', desc: 'Pendaftaran awal, verifikasi dokumen, dan seleksi berkas.' },
            { title: 'Pembayaran Kedua', amount: 'gratis', desc: 'Pengurusan kontrak kerja, medical check-up, legalitas dokumen.' },
    ...
    },
    {
        ...
        borderColor: 'border-red-600',
        bgColor: 'bg-red-50 dark:bg-red-950/20',
        description: 'Program penempatan tenaga kerja ke Hongkong di sektor hospitality, careworker, dan ART.',
        requirements: [
            'Usia Min 18 tahun',
            'Sehat jasmani & rohani',
            'Pendidikan min. SMP/sederajat',
    ...
    },
    {
        ...
        description: 'Program penempatan tenaga kerja ke Inggris di sektor perkebunan (Seasonal Worker) dan hospitality.',
        requirements: [
            'Usia Min 18 tahun',
            'Sehat jasmani & rohani',
            'Pendidikan min. SMA/sederajat',
        ...
        stages: [
            { title: 'Pembayaran Pertama', amount: 'Rp 10.000.000', desc: 'Pendaftaran awal, verifikasi dokumen, dan seleksi berkas.' },
            { title: 'Pembayaran Kedua', amount: 'Rp 30.000.000', desc: 'Pengurusan kontrak kerja, sertifikasi (Certificate of Sponsorship), dan visa.' },
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {countries.map((country) => (
                            <button
                                ...
                                className={`relative group text-left p-6 rounded-2xl border-2 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${selected?.id === country.id
