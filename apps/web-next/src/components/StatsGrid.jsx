...
export default function StatsGrid({ stats }) {
    ...
    const defaultStats = [
        { label: 'Total Pelamar', value: '0', change: '', icon: 'group', color: 'text-primary', bg: 'bg-primary/10' },
        { label: 'Pelamar Hari Ini', value: '0', change: '', icon: 'today', color: 'text-blue-500', bg: 'bg-blue-500/10' },
        { label: 'Menunggu Review', value: '0', change: '', icon: 'pending_actions', color: 'text-orange-500', bg: 'bg-orange-500/10' },
        { label: 'Diterima Kerja', value: '0', change: '', icon: 'check_circle', color: 'text-green-500', bg: 'bg-green-500/10' },
    ];
