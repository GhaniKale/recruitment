                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <a href="https://wa.me/6285972842784" target="_blank" rel="noopener noreferrer" className="inline-flex justify-center items-center px-8 py-4 rounded-xl bg-accent text-white font-semibold text-lg hover:bg-accent-hover transition-all shadow-xl shadow-accent/25">
