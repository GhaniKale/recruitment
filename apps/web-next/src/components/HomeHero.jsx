                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap gap-4">
                            <Link href="/biaya" className="inline-flex justify-center items-center px-8 py-4 rounded-xl bg-primary text-white font-semibold text-lg hover:bg-primary-hover transition-all shadow-xl shadow-primary/25 hover:-translate-y-1">
                                LIHAT PROGRAM
                                <span className="material-icons ml-2 text-xl">arrow_forward</span>
                            </Link>
                            <Link href="/cara-melamar" className="inline-flex justify-center items-center px-8 py-4 rounded-xl bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border-2 border-slate-200 dark:border-slate-700 hover:border-primary hover:text-primary dark:hover:text-primary font-semibold text-lg transition-all shadow-lg shadow-slate-200/50 dark:shadow-none hover:-translate-y-1">
                                CARA MELAMAR
                                <span className="material-icons ml-2 text-xl">help_outline</span>
                            </Link>
                            <a href="https://wa.me/6285972842784" target="_blank" rel="noopener noreferrer" className="inline-flex justify-center items-center px-8 py-4 rounded-xl bg-accent text-white font-semibold text-lg hover:bg-accent-hover transition-all shadow-xl shadow-accent/25 hover:-translate-y-1">
                    ...
                    <div className="relative lg:ml-auto">
                        ...
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-slate-200 dark:shadow-slate-900/50 border border-slate-100 dark:border-slate-800">
                            ...
                            <div className="absolute bottom-6 left-6 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700 flex items-center gap-4 max-w-xs">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-slate-900 dark:text-white">Izin Resmi</p>
                                    <p className="text-xs text-slate-500 dark:text-slate-400">Terdaftar & Legal</p>
                                </div>
                            </div>
                        </div>
                    </div>
